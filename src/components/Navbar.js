...
const Navbar = (props) => {
    ...
    if(token != null){
        ...
        logoutLink = <><Link className="btn btn-primary btn-lg mx-1" to="/login" role="button">Login</Link><Link className="btn btn-primary btn-lg mx-1" to="/signup" role="button">Signup</Link>'</>
    }
    return (
